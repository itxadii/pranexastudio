...
export default function UserProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="font-serif text-3xl font-bold text-deep-teal">My Profile</h2>
        <p className="text-text-muted text-sm mt-0.5">Manage your profile credentials and security.</p>
      </div>

      <div className="max-w-xl">
        <Card>
          <CardHeader>
            <CardTitle>Update Account Password</CardTitle>
            <CardDescription>Change your security credentials. We recommend a strong, unique password.</CardDescription>
          </CardHeader>
