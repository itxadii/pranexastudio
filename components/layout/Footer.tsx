...
export const Footer: React.FC = () => {
  ...
  // Hide footer on portal and login pages
  if (
  ...
  return (
    <footer className="bg-warm-cream border-t border-cream-dark py-16 mt-auto">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8 items-start">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3.5 text-[14px] text-text-muted leading-relaxed">
            <li className="flex items-start gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.0" stroke="currentColor" className="w-5 h-5 text-deep-teal shrink-0 mt-0.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
              </svg>
              <span>Pranexa Studio, Shah House, Mumbai, India</span>
            </li>
            <li className="flex items-center gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.0" stroke="currentColor" className="w-5 h-5 text-deep-teal shrink-0">
            ...
            <li className="flex items-center gap-3">
              ...
              <span>info@pranexastudio.com</span>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-cream-dark flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-text-muted">
        <p>© {new Date().getFullYear()} Pranexa Studio. All Rights Reserved. Designed for premium yoga experiences.</p>
